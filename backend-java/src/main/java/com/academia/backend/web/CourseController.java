...
public class CourseController {
  ...
  public CourseController(CourseService courseService, JwtService jwtService, UserRepo userRepo) {
  ...
  @SecurityRequirement(name = "bearerAuth")
  @Operation(summary = "Listar todos los cursos (solo administradores)")
  public ResponseEntity<Page<CourseDto>> getAllCourses(
    ...
    if (user.getRole() != Role.ADMIN && user.getRole() != Role.SUPER_ADMIN) {
      throw new ResponseStatusException(HttpStatus.FORBIDDEN, "Solo administradores pueden ver todos los cursos");
    }
  ...
  @DeleteMapping("/{id}")
  @SecurityRequirement(name = "bearerAuth")
  @Operation(summary = "Eliminar curso", description = "Archiva el curso (soft delete) - Solo administradores")
